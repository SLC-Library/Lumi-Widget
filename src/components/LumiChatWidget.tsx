            ...
            <div className="max-w-2xl mx-auto w-full space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  { titleTh: 'ระบบจองห้องประชุม SLC Room Booking', titleEn: 'SLC Room Booking Portal', descTh: 'จองห้องประชุมและห้องศึกษาออนไลน์', descEn: 'Reserve meeting and group study rooms online', url: 'https://slc-library.github.io/SLC_RoomBooking/', icon: Building },

...
(function() {
  ...
  // SVG Mascot Helper
  const getLumiMascotSvg = (size = 36) => `
  ...
  const FAQS = [
    {
      ...
      catTh: 'บริการยืม-คืน',
      catEn: 'Circulation',
      qTh: 'ยืมหนังสือได้กี่วัน และต่ออายุได้อย่างไร?',
      qEn: 'What is the loan period and how to renew?',
      ...
      links: [
        { titleTh: 'เข้าสู่ระบบ Web OPAC เพื่อยืมต่อ', titleEn: 'Web OPAC System', url: 'http://slclib.slc.ac.th/' }
      ]
    },
    {
      id: 2,
      ...
      links: [
        { titleTh: 'ระบบจองห้องประชุม SLC Room Booking', titleEn: 'SLC Room Booking Portal', url: 'https://slc-library.github.io/SLC_RoomBooking/' }
      ]
    },
    {
      id: 3,
      ...
      aEn: '⏰ **Library Hours of Operation:**\n• **Central Library Saint Louis (Hospital Side):** Daily, 10:00 AM - 7:00 PM\n• **Saint Benedict Branch (Academic Building Side):** Monday - Friday, 8:00 AM - 5:00 PM\n• *Closed on Public Holidays*'
    },
    {
      id: 4,
      catTh: 'วิทยานิพนธ์',
      ...
      aTh: '🎓 คุณสามารถสืบค้นและดาวน์โหลดวิทยานิพนธ์และงานนิพนธ์ฉบับเต็มได้ฟรี ผ่านระบบ **คลังสารสนเทศดิจิทัล วิทยาลัยเซนต์หลุยส์ (SLC Digital Collection)** ตามลิงก์ด้านล่างนี้ครับ',
      aEn: '🎓 Access and download full-text institutional dissertations via **The Saint Louis College Digital Collections (SLC Digital Collection)**:',
      links: [
    ...
    },
    {
      ...
      catEn: 'Databases',
      qTh: 'ใช้งานฐานข้อมูลวิจัยออนไลน์จากนอกวิทยาลัยได้อย่างไร?',
      qEn: 'How to access online research databases off-campus?',
    ...
    },
    {
      ...
      qTh: 'ขั้นตอนการยืมหนังสือต่อออนไลน์ทำอย่างไร?',
  ...
  const RESOURCES = [
    ...
    },
    {
      ...
      titleEn: 'Purchase Recommendation',
      descTh: 'แบบฟอร์มเสนอแนะหนังสือหรือสื่อเข้าห้องสมุด',
      descEn: 'Recommend new books or resources for acquisition.',
      url: 'https://library.slc.ac.th/lib2025/nav2-6.php',
      query: 'เสนอซื้อทรัพยากรสารสนเทศเข้าห้องสมุด'
    }
  ];
  ...
  container.innerHTML = `
    ...
    >
      <div class="relative w-10 h-10 flex items-center justify-center bg-white rounded-full p-0.5 shadow-xs overflow-hidden">
        ${getLumiMascotSvg(36)}
      ...
      <div class="hidden sm:flex flex-col text-left pr-2">
        ...
        <span class="text-[10px] text-blue-200 uppercase tracking-widest font-semibold">ห้องสมุดเซนต์หลุยส์ • 24/7</span>
      </div>
    </button>
    ...
    >
      ...
      <aside class="w-14 sm:w-16 bg-slate-900 border-r border-slate-800 flex flex-col items-center py-4 justify-between select-none z-20 flex-shrink-0">
        <div class="flex flex-col items-center gap-3 w-full">
          <!-- Mascot Top Badge -->
          <div class="w-10 h-10 rounded-xl bg-blue-900/80 border border-blue-700/60 flex items-center justify-center p-0.5 shadow-sm">
            ${getLumiMascotSvg(32)}
          </div>
      ...
      <main class="flex-1 flex flex-col h-full bg-slate-50 relative min-w-0">
        ...
        <header class="bg-blue-900 text-white px-4 sm:px-5 py-3.5 sm:py-4 flex items-center justify-between flex-shrink-0 shadow-md">
          ...
          <div class="flex items-center gap-3 min-w-0">
            <div class="relative w-10 h-10 sm:w-11 sm:h-11 bg-[#00529a] rounded-full flex items-center justify-center p-0.5 overflow-hidden shadow-xs flex-shrink-0">
              ${getLumiMascotSvg(36)}
              <div class="absolute bottom-0 right-0 w-3 h-3 bg-emerald-400 rounded-full border-2 border-blue-900"></div>
            </div>
            <div class="min-w-0">
            ...
            <div class="max-w-2xl mx-auto w-full space-y-4">
              ...
              <div id="lumi-hero-card" class="bg-white border border-slate-200/90 rounded-2xl p-4 sm:p-5 shadow-xs">
                ...
                <div class="flex items-center gap-3.5 pb-3 border-b border-slate-100">
                  <div class="w-12 h-12 bg-blue-50 border border-blue-100 rounded-2xl flex items-center justify-center flex-shrink-0 p-1">
                    ${getLumiMascotSvg(44)}
                  </div>
                  <div>
          ...
          <div class="p-3 sm:p-4 bg-white border-t border-slate-100 flex flex-col gap-1.5 flex-shrink-0">
            <div class="max-w-2xl mx-auto w-full">
              <form id="lumi-input-form" class="flex items-center gap-2 bg-slate-100/90 rounded-2xl px-3.5 py-1.5 border border-slate-200 focus-within:border-blue-900 focus-within:bg-white focus-within:ring-2 focus-within:ring-blue-900/10 transition-all">
                ...
                <button 
                  type="submit"
                  class="p-2 rounded-xl bg-blue-900 hover:bg-blue-800 text-white shadow-xs transition-all flex items-center justify-center cursor-pointer"
                  title="ส่งข้อความ / Send"
                >
                  <svg class="w-4 h-4 translate-x-0.5 -translate-y-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
                </button>
              </form>
        ...
        <div id="lumi-resources-view" class="hidden flex-1 overflow-y-auto p-4 sm:p-6 bg-slate-50">
          <div class="max-w-2xl mx-auto w-full space-y-4">
            <div class="border-b border-slate-200 pb-3">
              ...
              <p id="lumi-resources-sub" class="text-xs text-slate-500 mt-0.5">เข้าถึงแคตตาล็อกหนังสือ ฐานข้อมูล และบริการต่างๆ ของวิทยาลัยเซนต์หลุยส์</p>
            </div>
  ...
  function renderResourcesList() {
    ...
    resourcesList.innerHTML = RESOURCES.map(r => `
      <div class="p-4 bg-white rounded-2xl border border-slate-200/90 shadow-xs hover:border-blue-300 hover:shadow-sm transition-all flex flex-col justify-between">
        <div>
          <h4 class="text-xs sm:text-sm font-bold text-slate-800 font-prompt">${isTh ? r.titleTh : r.titleEn}</h4>
          <p class="text-[11px] sm:text-xs text-slate-500 mt-1 leading-relaxed">${isTh ? r.descTh : r.descEn}</p>
        </div>
        <div class="mt-3.5 flex flex-col gap-1.5">
          ...
          <button onclick="window.LumiWidget.sendMessage('${escapeQuotes(r.query)}')" class="w-full py-1.5 px-3 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-600 text-[11px] font-medium transition-colors flex items-center justify-center gap-1 cursor-pointer">
            <span>${isTh ? 'ถามน้องลูมิเกี่ยวกับบริการนี้' : 'Ask Lumi about this'}</span>
    ...
    guideContent.innerHTML = `
      <div class="p-4 bg-white rounded-2xl border border-slate-200/90 shadow-xs">
        ...
        <ul class="space-y-1.5 text-slate-600 leading-relaxed">
          ...
          <li>• <strong>${isTh ? 'ห้องสมุดสาขา Saint Benedict (ฝั่งอาคารเรียน):' : 'Saint Benedict Branch (Academic Side):'}</strong> ${isTh ? h.branchTh : h.branchEn}</li>
  ...
  function setLanguage(lang) {
    ...
    document.getElementById('lumi-resources-sub').innerText = isTh ? 'เข้าถึงแคตตาล็อกหนังสือ ฐานข้อมูล และบริการต่างๆ ของวิทยาลัยเซนต์หลุยส์' : 'Access the book catalog, databases, and library services';
  ...
  function renderFaqList() {
    ...
    faqItemsList.innerHTML = filtered.map(f => `
      <div class="p-4 bg-white rounded-2xl border border-slate-200/90 shadow-2xs hover:border-blue-300 hover:shadow-xs transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3 group">
        ...
        <button 
          onclick="window.LumiWidget.sendMessage('${escapeQuotes(isTh ? f.qTh : f.qEn)}')"
  ...
  function generateBotResponse(query) {
    ...
    if (q.includes('ต่ออายุ') || q.includes('ต่อหนังสือ') || q.includes('renew') || q.includes('opac')) {
      return {
        text: isTh
    ...
    if (q.includes('จอง') || q.includes('ห้องประชุม') || q.includes('room') || q.includes('booking') || q.includes('reservation')) {
      return {
        text: isTh
          ? "🏢 **ระบบจองห้องประชุมออนไลน์:**\nสามารถจองห้องประชุมเพื่อการเรียนรู้และการทำกิจกรรมกลุ่มได้สะดวกรวดเร็วผ่านระบบ SLC Room Booking ตามลิงก์ด้านล่างนี้ครับ"
          : "🏢 **Online Meeting Room Reservation:**\nYou can book group study and meeting rooms easily via the SLC Room Booking system:",
        links: [
          { titleTh: 'ระบบจองห้องประชุม SLC Room Booking', titleEn: 'Book Meeting Room', url: 'https://slc-library.github.io/SLC_RoomBooking/' }
        ]
      };
    }
    ...
    if (q.includes('วิทยานิพนธ์') || q.includes('thesis') || q.includes('dissertation')) {
      return {
        text: isTh
    ...
    if (q.includes('ฐานข้อมูล') || q.includes('database') || q.includes('cinahl') || q.includes('off-campus') || q.includes('นอกวิทยาลัย')) {
      return {
        text: isTh
          ? "🌐 **ฐานข้อมูลออนไลน์ของวิทยาลัยเซนต์หลุยส์:**\nให้บริการฐานข้อมูล เช่น CINAHL, CU-eLibrary, IG Library, Scientific e-Resources โดยเข้าผ่านหน้าทรัพยากรดิจิทัล และใช้รหัสผ่านสำหรับใช้งานภายนอกสถาบัน"
          : "🌐 **Online Databases:**\nAccess premium databases including CINAHL, CU-eLibrary, IG Library, and Scientific e-Resources off-campus using institutional credentials.",
        links: [
          { titleTh: 'หน้ารวมฐานข้อมูล (Digital Resources)', titleEn: 'Digital Resources Portal', url: 'https://library.slc.ac.th/lib2025/nav1-1-e-databases.php' },
          { titleTh: 'ดูรหัสผ่านฐานข้อมูล (Google Drive)', titleEn: 'View Database Passwords', url: 'https://drive.google.com/file/d/1t2GBJjmyI2Pk5_objWsqQwXuju6KhlFO/view?usp=sharing' }
        ]
